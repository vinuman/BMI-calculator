  ...
  return (
    <div className="relative">
      ...
      <section className="w-[100%] flex flex-col">
        {/* left */}
        <div className="md:px-24 py-12 flex flex-col md:flex-row items-center md:items-start md:w-[50%] w-[100%] bg-gradient-to-l from-[#D6E6FE] via-[rgba(214, 252, 254, 0.00)] md:rounded-b-[35px]">
      ...
      {/*  HABITS SECTION */}
      <div className="flex md:flex-row flex-col justify-around md:w-[90%] rounded-lg mx-auto py-16 px-8 bg-gradient-to-r from-#D6E6FE via-transparent to-transparent">
        <div className="flex items-center justify-center gap-4 md:flex-col md:w-[25%] w-[100%] ">
          <img
        ...
        <div className="flex items-center justify-center gap-4 md:flex-col md:w-[25%] w-[100%]  py-8">
      ...
      <section className="px-8 py-16">
        ...
        <div className="flex justify-between px-32 pb-4">
          <div className="flex flex-col w-[50%] rounded-r-xl">
          ...
          <div className="flex flex-col w-[30%] shadow-xl p-8">
        ...
        <div className="flex gap-12 justify-end">
          <div className="flex flex-col w-[30%] shadow-xl p-8 rounded-xl">
            <div className="flex items-center pb-4 gap-4">
              <img
                className="w-[32px] h-[32px]"
